...
export default function Pagina12 ({ navigation }) {
    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.header}>
            <TouchableOpacity onPress={() => navigation.navigate('Home')} style={styles.buttonHome}>
                ...
                <Text style={styles.indiceActive}>12</Text>
        ...
        <ScrollView showsVerticalScrollIndicator={true}>
            <View style={styles.form}>
                ...
                <Text style={styles.formTitulo}>       TEMPO UTILIZADO NA{"\n"}REALIZAÇÃO DOS CURATIVOS</Text>
...
limpeza da ferida.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>2.</Text> Entre 5 e 15 minutos.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>3.</Text> Entre 15 e 30 minutos.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>4.</Text> Superior a 30 minutos.</Text>


            </View>
        </ScrollView>
        <View style={styles.footer}>
            <TouchableOpacity onPress={() => navigation.navigate('Resultado')} style={styles.button}>
