...
export default function Pagina7 ({ navigation }) {
    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.header}>
            <TouchableOpacity onPress={() => navigation.navigate('Home')} style={styles.buttonHome}>
                ...
                <Text style={styles.indiceActive}>7</Text>
        ...
        <ScrollView showsVerticalScrollIndicator={true}>
            <View style={styles.form}>
                ...
                <Text style={styles.formTitulo}>ELIMINAÇÃO</Text>
                ...
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>2.</Text> Uso de vaso sanitário
                    com auxílio.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>3.</Text> Uso de comadre ou
                    eliminações no leito.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>4.</Text> Evacuação no leito e uso
                    de VD para controle de
                    diurese.</Text>
                <Text>*VD: Sonda Vesical de Demora</Text>


            </View>
        </ScrollView>
        <View style={styles.footer}>
            <TouchableOpacity onPress={() => navigation.navigate('Pagina8')} style={styles.button}>
