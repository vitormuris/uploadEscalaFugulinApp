    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.header}>
            <TouchableOpacity onPress={() => navigation.navigate('Home')} style={styles.buttonHome}>
                ...
                <Text style={styles.indiceActive}>5</Text>
        ...
        <ScrollView showsVerticalScrollIndicator={true}>
            <View style={styles.form}>
                ...
                <Text style={styles.formTitulo}>ALIMENTAÇÃO</Text>
                ...
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>2.</Text> VO com auxílio.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>3.</Text> Através de SNG ou SNE.</Text>
                <Text onPress={alerta} style={styles.answers}><Text style={styles.numIndicador}>4.</Text> Através de cateter central.</Text>
                <Text>*VO: Via Oral; SNG: Sonda Nasogástrica; SNE:Sonda Nasoenteral</Text>

            </View>
        </ScrollView>
        <View style={styles.footer}>
            <TouchableOpacity onPress={() => navigation.navigate('Pagina6')} style={styles.button}>
